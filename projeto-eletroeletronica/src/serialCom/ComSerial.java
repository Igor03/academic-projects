 ...
 * @author This
 */
public class ComSerial implements Runnable, SerialPortEventListener {
    ...
    public ComSerial( String p , int b , int t ){
        this.Porta = p;
        this.baudrate = b;
        this.timeout = t;
    }
    ...
    public void ObterIdDaPorta(){
        try {
            ...
            System.out.println("Erro ao obter o ID da porta: " + e);
            IDPortaOK = false;
            System.exit(1);
        }
    }
