...
/* Como parâmetro de todas as funções, foram usados os nomes originais das estruturas 
   utilizadas na função main para facilitar a leirura*/
...
void cooc_matrix (IMAGE *img, MATRICES *matrix){	// Função que calcula a matriz de coocorrência/GLCM
...
void show_cooc (MATRICES *matrix){		// Função que mostra a matriz de coocorrência/GLCM
